  ...
  const pillars = [
    {
      ...
      icon: ShieldAlert,
      tag: "Core Shield",
      badgeColor: "bg-[#fef0f2] text-[#df1b41] border-[#fbc5cd]",
      features: [
    ...
    },
    {
      ...
      icon: Cpu,
      tag: "High Velocity",
      badgeColor: "bg-[#e6fbf7] text-[#00a389] border-[#a3f3e5]",
      features: [
    ...
    },
    {
      ...
      badgeColor: "bg-[#fff4e5] text-[#b25e00] border-[#ffd8a8]",
      features: [
    ...
    },
    {
      ...
      icon: Wrench,
      tag: "Pro Workflow",
      badgeColor: "bg-[#f0f3ff] text-[#635bff] border-[#d6dcff]",
      features: [
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {pillars.map((pillar, i) => {
            ...
            return (
              <div
                key={i}
                className="stripe-card p-8 sm:p-10 flex flex-col justify-between bg-white"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="h-12 w-12 rounded-2xl bg-[#f8faff] border border-[#e6e8eb] flex items-center justify-center shadow-xs">
                  ...
                  <h3 className="text-2xl font-extrabold text-[#0a2540] mb-2 tracking-tight">
                    {pillar.title}
                  </h3>
                ...
                <ul className="space-y-3 pt-6 border-t border-[#e6e8eb]">
                  {pillar.features.map((feat, idx) => (
                    <li key={idx} className="flex items-start gap-2.5 text-xs sm:text-sm text-[#425466] font-medium">
