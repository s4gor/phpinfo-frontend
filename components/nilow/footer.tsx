...
export default function NilowFooter() {
  return (
    <motion.div
      ...
      <motion.div variants={itemVariants}>
        <span className="text-zinc-600">Nilow - a product by </span>
        <Link href="https://exeebit.com" rel="noopener noreferrer" target="_blank">
          <span className="text-zinc-800 underline underline-offset-2 transition-all duration-200 ease-linear hover:text-emerald-700">
            Exeebit
          </span>
        </Link>
      ...
      <motion.div variants={itemVariants} className="flex flex-wrap items-center justify-center gap-5 text-zinc-600">
        <Link href="/impressum" className="hover:text-emerald-700">
          Impressum
        </Link>
        <Link href="/nilow/privacy" className="hover:text-emerald-700">
          Privacy Policy
        </Link>
        <Link href="/nilow/terms" className="hover:text-emerald-700">
          Terms
        </Link>
        <Link href="/nilow/delete-account" className="hover:text-emerald-700">
          Delete account
        </Link>
